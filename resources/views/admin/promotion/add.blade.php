                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="ma_khuyen_mai" id="ma_khuyen_mai" class="form-control" placeholder="Nhập mã khuyến mãi..." value="{{ old('ma_khuyen_mai') }}">
                            @error('ma_khuyen_mai')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="loai_khuyen_mai" id="loai_khuyen_mai" class="form-select">
                                <option value="0" {{ old('loai_khuyen_mai') == 0 ? 'selected' : '' }}>Giảm theo số tiền</option>
                                <option value="1" {{ old('loai_khuyen_mai') == 1  ? 'selected' : '' }}>Giảm theo phần trăm</option>
                                <option value="2" {{ old('loai_khuyen_mai') == 2 ? 'selected' : '' }}>Miễn phí vận chuyển</option>
                                <option value="3" {{ old('loai_khuyen_mai') == 3 ? 'selected' : '' }}>Tặng quà kèm theo</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" name="ngay_bat_dau" id="ngay_bat_dau" value="{{old('ngay_bat_dau')}}">
                            @error('ngay_bat_dau')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" name="ngay_ket_thuc" id="ngay_ket_thuc" value="{{old('ngay_ket_thuc')}}">
                            @error('ngay_ket_thuc')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="ten_khuyen_mai" id="ten_khuyen_mai" class="form-control" value="{{ old('ten_khuyen_mai') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="trang_thai" id="trang_thai" class="form-select">
                                <option value="0" {{ old('trang_thai') ==0  ? 'selected' : '' }}>Kích hoạt</option>
                                <option value="1" {{ old('trang_thai') == 1 ? 'selected' : '' }}>Không kích hoạt</option>
                            </select>
                        </div>
