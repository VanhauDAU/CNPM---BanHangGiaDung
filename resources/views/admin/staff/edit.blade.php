...
<div class="container">
    <h1 class="text-center mb-4 fw-bold"><i class="fa-solid fa-plus"></i>Sửa Nhóm</h1>
    ...
    <form action="{{-- route('admin.add_user') --}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="mb-3">
                ...
                <input type="text" id="ten_chuc_vu" name="ten_chuc_vu" class="form-control" placeholder="Nhập tên nhóm..." value="{{old('ten_chuc_vu') ?? $staff->ten_chuc_vu}}">
                @error('ten_chuc_vu')
