...
<div class="container mt-5">
    <div class="row justify-content-between mb-3" style="margin-top: -30px">
        ...
        <div class="col-auto">
            ...
            <a href="{{route('admin.products.addDm')}}"  class="btn btn-danger me-2">Thêm Danh Mục</a>
                    ...
                    @foreach(getAllDanhMucSp2() as $key => $category)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.products.deleteDm', $category->id_danh_muc) }}" method="POST" style="display:inline; "id="delete-form-{{$key}}">
                                    @csrf
                                    @method('DELETE')
