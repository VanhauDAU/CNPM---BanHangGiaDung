        ...
        <div class="col-md-9 product-list">
            ...
            <div class="row">
                ...
                @foreach ($productList as $product)
                    <div class="col-6 col-md-4 col-lg-3 mb-4" style="padding:0px 2px 0px ">
                        <a href="{{route('home.chi_tiet_sp',$product->maSP)}}">
                            <div class="product-item p-2 d-flex flex-column" style="border-radius: 10px; background-color: #fff; transition: transform 0.3s ease;">
                                ...
                                <a href="{{route('home.chi_tiet_sp',$product->maSP)}}" class="btn mt-1 btn-xemchitiet">Xem Chi Tiết</a>
                            </div>
                        </a>
                    </div>
                @endforeach
